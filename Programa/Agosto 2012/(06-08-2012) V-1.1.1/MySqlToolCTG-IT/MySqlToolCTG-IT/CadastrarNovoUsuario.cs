...
namespace MySqlToolCTG_IT
{
    public partial class CadastrarNovoUsuario : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Controlar.Modificadores("Insert into tbl_login (login,senha) values('" + Encriptografar.EncriptografarString(tb_login.Text) + "','" + Encriptografar.EncriptografarString(tb_senha.Text) + "');", true, "Usuário inserido com sucesso!", "Atenção!");
                this.Close();
            }          
        }
