    ...
    public partial class TelaPrincipal : Form
    {
        ...
        public void VerificaFeedBack()
        {
            try
            {
                ...
                ControladoresBD.Visualizador("Select * from tbl_feedback where usuario = '" + Encriptografar.EncriptografarString(Program._LoginUsuario) + "' and versao = '" + Program._VersaoPrograma + "';", 0);
