...
namespace MySqlToolCTG_IT
{
    public partial class TelaPrincipal : Form
    {
        ...
        public void PreencherTreeView()
        {
            ...
            CAaccess.Visualizadores("Select * from tbl_login where login = '" + Program._LoginUsuario + "';", 1);
        ...
        private void abrirCentralDeAjudaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            centraldeAjuda._URL = @"C:\wamp\www\SiteMysqlTool\index.php";
            centraldeAjuda.Show();
        }

        private void button3_Click(object sender, EventArgs e)
        {
            CriptografarHD hd = new CriptografarHD();
            MessageBox.Show(hd.hdCrip()+ "\nNumero de caracteres: "+hd.hdCrip().Length);
        }
    }
}
