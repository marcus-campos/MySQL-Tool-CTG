...
namespace MySqlToolCTG_IT
{
    public partial class BugTracker : Form
    {
        ...
        {            
            ...
            else
            {
                ...
                else
                {
                    ...
                    controlarDB.Modificador("Insert into tbl_bugs(assunto,descricao,login,data_reportado) values('" + tb_assunto.Text + "','" + rtb_desc.Text + "','" + Program._LoginUsuario + "/" + usu_Windows.Name + "',sysdate());", true, "Bug cadastrado com sucesso!");
                    CarregarGrid();
        ...
        public void CarregaGridADM()
        {
            ...
            dg_bugs.Columns[0].HeaderText = "Codigo do bug";
            dg_bugs.Columns[1].HeaderText = "Assunto";
            dg_bugs.Columns[2].HeaderText = "Descrição";
            dg_bugs.Columns[3].HeaderText = "Data reportado";
            dg_bugs.Columns[4].HeaderText = "Data corrigido";
        }
        ...
        public void CarregarGrid()
        {
            ...
            _OldConectStr = Program._ConectionStringMySql;
            Program._ConectionStringMySql = Program._ConectionStringMySqlOnline;
            controlarDB.Visualizador("Select codigo,assunto,descricao,data_reportado,data_correcao from tbl_bugs where login = '" + Program._LoginUsuario + "/" + usu_Windows.Name + "';", 1, "dg_dadosArmazenados");
            dg_bugs.DataSource = controlarDB._dataSet;
            dg_bugs.DataMember = "dg_dadosArmazenados";            
            Program._ConectionStringMySql = _OldConectStr;
