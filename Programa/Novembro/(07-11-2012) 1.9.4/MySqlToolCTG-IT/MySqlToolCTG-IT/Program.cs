...
namespace MySqlToolCTG_IT
{
    ...
    {
        private static string VersaoPrograma = "1.9.4 (Beta)";
        ...
        private static string UltimaTabelaSelecionada = "";
        private static string CodigoUsuarioOnline = "";
        private static DataTable dadosUp;
        ...
        public static string _CodUsuOn
        {
            get { return CodigoUsuarioOnline; }
            set { CodigoUsuarioOnline = value; }
        }

        public static string _UltimaTabelaSelecionada
        {
            get { return UltimaTabelaSelecionada; }
            set { UltimaTabelaSelecionada = value; }
        }

        public static DataTable _dadosUp
        {
            get { return dadosUp; }
            set { dadosUp = value; }
        }
