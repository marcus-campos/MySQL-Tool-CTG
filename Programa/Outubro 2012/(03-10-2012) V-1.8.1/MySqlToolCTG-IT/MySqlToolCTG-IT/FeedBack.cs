...
namespace MySqlToolCTG_IT
{
    public partial class FeedBack : Form
    {
        ...
        public void EnviarFeedBack()
        {
            ...
            controlarDB.Modificador("Insert into tbl_feedback(nota,usuario,comentario,data_feedback,versao) values('" + tk_nota.Value + "','" + Program._LoginUsuario + "/" + usu_Windows.Name + "','" + rtb_comentario.Text + "',sysdate(),'" + Program._VersaoPrograma + "');", true, "FeedBack enviado com sucesso!");            
